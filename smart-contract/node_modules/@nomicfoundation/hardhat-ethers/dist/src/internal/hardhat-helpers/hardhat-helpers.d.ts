...
import type { Abi, Artifact, ArtifactManager, StringWithArtifactContractNamesAutocompletion } from "hardhat/types/artifacts";
...
export declare class HardhatHelpers {
    ...
    getContractFactory<A extends any[] = any[], I = EthersT.Contract>(name: StringWithArtifactContractNamesAutocompletion, signerOrOptions?: EthersT.Signer | FactoryOptions): Promise<EthersT.ContractFactory<A, I>>;
    ...
    getContractAt(nameOrAbi: StringWithArtifactContractNamesAutocompletion | Abi, address: string | EthersT.Addressable, signer?: EthersT.Signer): Promise<EthersT.Contract>;
    ...
    deployContract(name: StringWithArtifactContractNamesAutocompletion, args?: any[], signerOrOptions?: EthersT.Signer | DeployContractOptions): Promise<EthersT.Contract>;
    deployContract(name: StringWithArtifactContractNamesAutocompletion, signerOrOptions?: EthersT.Signer | DeployContractOptions): Promise<EthersT.Contract>;
